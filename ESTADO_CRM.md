...
| **Último commit de referencia** | D-22 ajuste: Zoho Mail es el canal principal de correo (institucional), Gmail queda secundario/opcional (este commit) |
...
## 3. Estado actual del código (v1.6.1) — YA EN GITHUB
...
1. `git pull` del repo (ya en `main`, v1.6.1).  
