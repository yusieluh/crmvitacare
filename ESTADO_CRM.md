...
| **Último commit de referencia** | D-28 Fase 3 (reestructuración de integraciones Meta): sección "Integraciones" por pestañas + asistente WhatsApp Embedded Signup — `Vitacare_Crm_Integrations_Page` + `Vitacare_Crm_Whatsapp_Embedded_Signup` (este commit) |
