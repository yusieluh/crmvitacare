...
| **Último commit de referencia** | Fix v1.15.2: agregar `config_id` de Facebook Login for Business al diálogo OAuth + acotar scopes de Messenger (este commit) |
